...
<template>
  <div class="h-screen flex flex-col justify-center items-center">
    <div class="md:mr-100 mr-80">
      <button
        @click="[storeCounter.showEProfile(), addNote]"
        class="rounded p-1 hover:bg-white hover:bg-opacity-80">
        <img src="/img/left.png" class="w-8 h-8 hover:opacity-80" />
      </button>
    </div>
    <div
      class="flex flex-col md:flex-col justify-center items-center bg-beigeL rounded-lg shadow-2xl w-96 md:w-200 h-auto md:h-128">
      <div
        class="flex flex-col md:grid md:grid-cols-2 mb-5 md:mb-16 md:mt-0 mt-5">
        <img
          class="w-60 h-60 border-solid border-2 border-beigeD rounded-xl shadow-xl mx-auto md:mb-0 mb-5"
          src="/img/ppic.png" />
        <div class="flex flex-col justify-center">
          <div class="mb-1 md:mb-4">
            ...
            <textarea
              v-model="userName"
              class="h-10 w-80 p-2 overscroll-none overflow-hidden resize-none border-gray-200 border-1 shadow-sm rounded focus:outline-none focus:border-beigeD focus:ring-beigeD focus:ring-1 focus:shadow-lg"
              >{{ userName }}</textarea
            >
          </div>
          <div class="mb-1 md:mb-4">
