...
<template>
    <div class="flex justify-center ">
        <div class="bg-beigeL pb-16 rounded pl-20 pr-20">
            ...
            <h1 class="text-beigeSD text-5xl font-bold flex justify-center mt-10 mb-10 ">Sign In</h1>
            ...
            <form>
                ...
                <div class="flex justify-center mt-10" >
                    <button :disabled="!email || !password" @click="[signIn(), setUserID(), storeCounter.showLogOutP()]" class="w-80 text-lg bg-beigeD h-10 rounded-lg shadow-lg hover:bg-beigeSD disabled:border-bg-black">
                        Sign In
                    </button>
                 </div>
             </form>
