    ...
    <div class="bg-beigeL rounded-lg shadow-2xl mt-11 w-96 md:w-200 h-3/4">
      ...
      <div
        ...
        <div
          ...
          class="flex flex-col bg-gray-200 rounded mb-5">
          <div class="grid content-between h-64 md:h-44">
            ...
            <textarea
              disabled
              class="px-3 py-1 font-semibold text-lg italic -mb-80 md:-mb-6 mx-3 md:mx-auto md:ml-8 h-10 w-64 md:w-150 rounded-md border-gray-300 border-1 shadow-sm overscroll-none overflow-hidden resize-none focus:outline-none focus:border-beigeD focus:ring-beigeD focus:ring-1 focus:shadow-lg">
              >{{ question.userAnswer }}</textarea
            >
            <textarea
              disabled
              class="px-3 py-1 font-semibold text-lg italic -mt-14 md:mt-0 mx-3 md:mx-auto md:ml-8 h-10 w-64 md:w-150 mb-2 rounded-md border-gray-300 border-1 shadow-sm overscroll-none overflow-hidden resize-none focus:outline-none focus:border-beigeD focus:ring-beigeD focus:ring-1 focus:shadow-lg"
      ...
      <div class="flex justify-center mt-5">
        <button
          @click="
            [storeCounter.showReviewQuiz(), storeCounter.showAnswerQuiz()]
          "
