...
<template>
    <div class="h-screen flex flex-col justify-center items-center">
        <div class="md:mr-100 mr-80">
            <button @click="storeCounter.showChangeQuiz" class="rounded p-1 hover:bg-white hover:bg-opacity-80">
                ...
                <div class="flex flex-col overflow-y-scroll pt-3 h-110 mb-8 bg-white mx-5 rounded shadow ">
                    ...
                    <div v-for="quiz in quizzes" class=" mx-3">
                        ...
                        <div class="flex justify-center">
                            <button @click="[setGlobalQuizID(quiz.id), storeCounter.showChangeQuiz()]" class="h-10 mb-3 w-170 mr-2 bg-beigeD rounded-3xl hover:bg-beigeSD">
                                {{ quiz.quiz_title }}
                            </button>
                            <button  @click="deletequiz(quiz.id)" class="justify-end h-10 text-black font-bold hover:text-red-500">
                                &cross;
                            </button>    
                        </div>
                    </div>
